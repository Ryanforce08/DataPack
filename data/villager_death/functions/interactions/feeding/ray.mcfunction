execute if score #vp.rayHit vp.raycast matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @e[type=#vnla_prt:feedables,limit=1,tag=!vp.fedMob,dx=0,sort=nearest] run function vnla_prt:interactions/feeding/check_entity
